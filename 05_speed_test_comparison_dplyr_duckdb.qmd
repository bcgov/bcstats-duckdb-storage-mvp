...
We will test speeds on the following `csv` files. These are currently saved locally but I'd like to get them from the LAN, since that is where files will be stored.
